	  		...
	  		return {
	  			...
	  			formRules: {
	  				username: [
						...
						{ min: 2, max:18, message: '用户名长度在2~18位之间', trigger: 'blur' }
					],
					password: [
...
<style lang="less" scoped>
	//@import '../common/css/less/var.less';
	/**----------------定义变量-------------------*/
